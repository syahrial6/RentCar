    ...
    <div>
      ...
      <div className="fixed bottom-5 right-5 z-50">
        <a
          ...
          className="flex items-center justify-center w-16 h-16 bg-white text-white rounded-full shadow-lg hover:bg-white transition-transform transform hover:scale-110"
        >
          <Image src="/call.svg"
          width={50}
          height={50}
